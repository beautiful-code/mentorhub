angular.module('mentorhub.track', [])
    ...
    .factory('TrackServices', ["$http", "ApiUrls", "Utils", function ($http, ApiUrls, Utils) {
        return {
    ...
    .controller('TrackController', ["$window", "$scope", "TrackServices", function ($window, $scope, TrackServices) {
